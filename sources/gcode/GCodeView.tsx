...
import { AmbientLight, BoxGeometry, Fog, GridHelper, Mesh, MeshStandardMaterial, PerspectiveCamera, PointLight, Scene, SpotLight } from 'three';

export const GCodeView = React.memo(() => {
    ...
    return (
        <GLView
            ...
            onContextCreate={async (gl: ExpoWebGLRenderingContext) => {
                ...
                (renderer as any).setClearColor(sceneColor);
                ...
                // const object = await loadAsync([model['3d.obj'], model['3d.mtl']], undefined, name => model[name]);
    ...
    constructor() {
        super(
            ...
            new MeshStandardMaterial({
                map: new TextureLoader().load(require('../assets/logo.png')),
                // color: 0xff0000
            })
        );
    }
